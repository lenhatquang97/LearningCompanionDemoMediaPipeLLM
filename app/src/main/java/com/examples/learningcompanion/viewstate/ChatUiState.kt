...
class ChatUiState(
    ...
    private val _messages: MutableList<ChatMessageModel> = messages.toMutableStateList()
    ...
    fun createLoadingMessage() {
        val chatMessage =
            ChatMessageModel(author = MODEL_PREFIX, isLoading = true, isThinking = supportsThinking)
